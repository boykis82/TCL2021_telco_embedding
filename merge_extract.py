...
'''
    python merge_extract.py --type CHG --input_path D:/data/변경계획서 --output_path D:/data/변경계획서/chg_merged.xlsx --from_ym 201706 --to_ym 202105
    python merge_extract.py --type SOR --input_path D:/data/SOR --output_path D:/data/SOR/sor_merged.xlsx --from_ym 201706 --to_ym 202105
    python merge_extract.py --type SOP --input_path D:/data/SOP --output_path D:/data/SOP/sop_merged.xlsx --from_ym 202001 --to_ym 202012
...
def parse_arguments():
    ...
    arg_parser.add_argument('--type', help='CHG(변경계획서), SOP(SOP), SOR(요청서), SOR_JIRA(JIRA요청서) ...', type=str)
    arg_parser.add_argument('--input_path', help='월 별 파일이 위치한 경로. 각 파일은 yyyymm.xlsx 포맷이어야 합니다. JIRA요청서는 HTML 포맷이어야 합니다.', type=str)
